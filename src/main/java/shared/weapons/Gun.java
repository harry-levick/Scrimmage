...
abstract class Gun extends Weapon {
	 ...
	 */
	public Gun(float _damage, float _weight, String _name, float _bulletSpeed, 
				float _fireRate, float _bulletWidth, float _range, 
				boolean _fullAutoFire, boolean _singleHanded) {
