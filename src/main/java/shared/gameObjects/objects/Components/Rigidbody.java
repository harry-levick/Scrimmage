...
/**
 * @author fxa579
 * The primary component responsible for all Physics updates; includes data and methods to process forces and gravity
 */
public class Rigidbody extends Component implements Serializable {
    ...
    public Rigidbody(RigibodyType bodyType, RigidbodyUpdateType updateMethod, float frictionCoefficient, float mass, float gravityScale,
                     float momentOfInertia, float angularCoefficient, float angularVelocity, float angularRadius, GameObject parent) {
