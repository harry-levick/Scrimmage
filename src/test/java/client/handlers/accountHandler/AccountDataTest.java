...
public class AccountDataTest {
  ...
  public void fromString() {
    ...
    achievements[2] = true;
    achievements[5] = true;
    AccountData source = new AccountData(UUID.randomUUID().toString(), "SamuraiJack2993", achievements, achievements, 12, 369);
    String[] saveQuery = source.saveQuery();
    String out = saveQuery[0] + "//x/s" + saveQuery[1] + "//x/s" + saveQuery[2] + "//x/s" + saveQuery[3] + "//x/s" + saveQuery[4] + "//x/s" + saveQuery[5];
